...
package br.eti.caratti.AntennaTunerTwoServo;
...
public class BluetoothTuner extends Activity implements OnSeekBarChangeListener {
	...
	private Boolean fineTuner = Boolean.FALSE;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		seekbarTune.setMax(1990);
		seekbarTune.setProgress(995);
		...
		seekbarFineTune.setMax(1990);
		seekbarFineTune.setProgress(995);
		seekbarFineTune.setOnSeekBarChangeListener((OnSeekBarChangeListener) this);
		
		
		seekbarAux = (SeekBar) findViewById(R.id.SeekBarAux);
		seekbarAux.setMax(50);
		seekbarAux.setProgress(25);		
		seekbarAux.setOnSeekBarChangeListener((OnSeekBarChangeListener) this);
	...
	private void fineTuner() {
		fineTuner = Boolean.FALSE;
		// seekbar.setMax(max)
	...
	public void handleMaxTuning(View v) {
		sendMessage("M");
		seekbarTune.setProgress(1990);
		seekbarFineTune.setProgress(1990);
		seekbarAux.setProgress(25);
	}
	...
	public void onProgressChanged(SeekBar seekBar, int progress,
		...
		case R.id.seekBarTuner:
			seekPos = progress + 510;
 		    sendMessage("T"+seekPos+"#");
 			seekbarFineTune.setProgress(995);
			break;
		case R.id.SeekBarAux:
			sendMessage("A"+(seekPos + progress - 25)+"#");
			break;			
		case R.id.SeekBarFineTuner:
	 		sendMessage("F"+ (progress + 510) +"#");
			break;
		}
